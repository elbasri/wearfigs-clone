...
/*             {"Core Scrubs": { link: ""}},
    ...
    return (
        <>
            ...
            <div className='filterTabClass'>
                            <div className="categoriesTab m-4">
                                    <ul className="list-unstyled">
                                        <li className="my-3">Women&apos;s Home</li>
                                        <li className="my-3">NIGHT SKY + VAPOR BLUE + ELECTRIC ORCHID</li>
